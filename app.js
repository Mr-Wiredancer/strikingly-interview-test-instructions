...
(function() {
  var BbExpert, DEBUG, Hangman, HhExpert, HhnewExpert, HwfcExpert, NaiveExpert, NmExpert, SbExpert, fs, letters, requestify, util;
  ...
  Hangman = (function() {
    function Hangman() {
      ...
      this.missed = '';
      this.letterIndex = 0;
      this.experts = [new SbExpert(this, 0), new NaiveExpert(this, 1), new NmExpert(this, 2), new HhExpert(this, 3), new HhnewExpert(this, 4), new HwfcExpert(this, 5)];
      this.voteCount = 0;
      this.votes = [];
      this.weights = [];
      _ref = this.experts;
    ...
    Hangman.prototype.initiateGame = function(secret, numWordsGuess, numGuessesPerWord) {
      ...
      fs.open('games.txt', 'a', 0x1b6, function(err, fd) {
        return fs.write(fd, game.secret + "\n", null, void 0, function() {});
      });
    ...
    Hangman.prototype.callVote = function() {
      var expert, index, _i, _len, _ref, _results;
    ...
    Hangman.prototype.vote = function(choice, expertIndex) {
      ...
      if (this.votes.indexOf(null) < 0) {
        return this.sendGuessRequest(this.getBestGuess());
      }
    };

    Hangman.prototype.getBestGuess = function() {
      var count, index, item, sortedVotes, theNum, total, totalWeight, vote, vw, w, _i, _j, _len, _len1, _ref;
      ...
      DEBUG && this.log(this.weights);
      for (_j = 0, _len1 = sortedVotes.length; _j < _len1; _j++) {
        item = sortedVotes[_j];
        vote = item.vote;
        vw = total[vote];
        theNum -= vw;
